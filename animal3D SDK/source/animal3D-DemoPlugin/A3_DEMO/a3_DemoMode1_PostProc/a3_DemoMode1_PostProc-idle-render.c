...
void a3postproc_render(a3_DemoState const* demoState, a3_DemoMode1_PostProc const* demoMode, a3f64 const dt)
{
	...
	const a3_Framebuffer* writeFBO[postproc_renderPass_max] = {
		...
		demoState->fbo_c16_szQuarter + 1,	//blur H quarter
		demoState->fbo_c16_szQuarter + 2,	//blur V quarter
		demoState->fbo_c16_szEighth + 0,	//bright eighth
		demoState->fbo_c16_szEighth + 1,	//blur H eighth
		demoState->fbo_c16_szEighth + 2,	//blur V eighth
	...
	//Blur pass (Horizontal), quarter sized
	currentDemoProgram = demoState->prog_postBlur;
	a3shaderProgramActivate(currentDemoProgram->program);
	...
	//Blur pass (Verticle), quarter sized
	currentDemoProgram = demoState->prog_postBlur;
	a3shaderProgramActivate(currentDemoProgram->program);
	pixelSize.x = 0.0f;
	pixelSize.y = 1.0f / (float)currentWriteFBO->frameHeight;
	...
	//Blur pass (Horizontal), eighth sized
	currentDemoProgram = demoState->prog_postBlur;
	a3shaderProgramActivate(currentDemoProgram->program);
	pixelSize.x = 1.0f / (float)currentWriteFBO->frameWidth;
	pixelSize.y = 0.0f;
	...
	//Blur pass (Verticle), eighth sized
	currentDemoProgram = demoState->prog_postBlur;
	a3shaderProgramActivate(currentDemoProgram->program);
	pixelSize.x = 0.0f;
	pixelSize.y = 1.0f / (float)currentWriteFBO->frameHeight;
